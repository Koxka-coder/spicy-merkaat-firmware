...
Código ESP-IDF para los nodos ESP32: drivers de sensores, FSM de zonas, cliente MQTT, integración ESP-WIFI-MESH y OTA con rollback.

## Project Overview

This is an ESP-IDF v5.x C project for ESP32 microcontrollers. The firmware provides a complete IoT solution with the following features:
...
- **ESP32 toolchain**: Installed automatically with ESP-IDF
...
- **Storage**: 512KB for additional data storage
